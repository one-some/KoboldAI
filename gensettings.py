gensettingstf = [
  ...
  "tooltip": "Shows debug information.",
    ...
    "UI_V2_Only": True,
 	...
 	"step": 0.1,
 	"default": 1,
	"tooltip": "Strength of applied Classifier-Free Guidance. As the value increases, the adherance to the CFG prompt increases, at the expense of generation quality. Set to 1 to disable.",
    "menu_path": "context",
    "sub_path": "cfg",
    "classname": "story",
    "name": "cfg_scale",
